...
export default function ComplaintCard({ complaint, showResident = false }) {
  ...
  return (
    <div className="bg-[#faf8f3] border border-[#d8cdbc] hover:border-[#5f4b3b]/60 transition-all p-5 sm:p-6 flex flex-col justify-between shadow-sm rounded-none">
      <div>
        ...
        <h4 className="font-serif text-lg font-normal text-[#24211e] mb-1.5 line-clamp-1">
          {complaint.title}
        </h4>
        <p className="text-sm text-[#6b665e] line-clamp-2 mb-4 leading-relaxed">
