  ...
  return (
    <div className="editorial-page-surface min-h-[calc(100vh-5rem)] py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Filter Bar */}
        <div className="bg-[#faf8f3] p-4 sm:p-5 border border-[#d8cdbc] shadow-sm flex flex-wrap gap-3 items-center justify-between rounded-none">
          <div className="flex items-center gap-2.5 flex-wrap flex-1">
            ...
            <select
              ...
              className="text-xs sm:text-sm bg-[#FAF8F5] border border-[#d8cdbc] text-[#24211e] py-1.5 px-3 focus:border-[#5f4b3b] focus:outline-none rounded-none"
            >
        ...
        {!loading && complaints.length === 0 ? (
          ...
          <div className="bg-[#faf8f3] border border-[#d8cdbc] shadow-sm overflow-hidden rounded-none">
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <select
                          ...
                          className="text-xs font-semibold uppercase tracking-wider bg-[#FAF8F5] border border-[#d8cdbc] text-[#24211e] py-1 px-2.5 focus:border-[#5f4b3b] focus:outline-none shadow-sm rounded-none"
                        >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right space-x-2">
                        {c.status !== 'RESOLVED' && (
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-[#FAF8F5] bg-[#24211e] hover:bg-[#3f3025] border border-[#24211e] shadow-sm transition-colors rounded-none"
                          >
                        ...
                        <Link
                          to={`/complaints/${c.id}`}
                          className="inline-flex items-center px-2.5 py-1.5 text-xs text-[#5f4b3b] hover:text-[#24211e] bg-[#ebe5da] hover:bg-[#d8cdbc] border border-[#d8cdbc] transition-colors rounded-none"
              ...
              <div className="px-6 py-4 bg-[#FAF8F5] border-t border-[#d8cdbc] flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-4 py-2 border border-[#d8cdbc] text-xs font-semibold uppercase tracking-wider text-[#24211e] bg-[#faf8f3] hover:bg-[#ebe5da] disabled:opacity-50 inline-flex items-center transition-colors rounded-none"
                  >
