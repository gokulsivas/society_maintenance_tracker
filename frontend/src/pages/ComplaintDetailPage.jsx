    ...
    <div className="editorial-page-surface min-h-[calc(100vh-5rem)] py-8 sm:py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#d8cdbc] pb-4">
          <div className="flex items-center space-x-3">
            <button
              ...
              className="p-2.5 text-[#24211e] hover:bg-[#ebe5da] bg-[#faf8f3] border border-[#d8cdbc] shadow-sm transition-colors rounded-none"
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="px-2 py-0.5 text-xs font-semibold uppercase tracking-wider bg-[#ebe5da] text-[#5f4b3b] border border-[#d8cdbc] rounded-none whitespace-nowrap">
                  {complaint.category}
                </span>
              </div>
          ...
          <div className="complaint-header-actions flex items-center gap-5 flex-wrap">
            ...
            {canEdit && (
              <button
                ...
                className="inline-flex items-center px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#24211e] bg-[#ebe5da] hover:bg-[#d8cdbc] border border-[#d8cdbc] shadow-sm transition-all rounded-none"
              >
            ...
            {isAdmin && complaint.status !== 'RESOLVED' && (
              <button
                ...
                className="inline-flex items-center px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#FAF8F5] bg-[#24211e] hover:bg-[#3f3025] border border-[#24211e] shadow-sm transition-all rounded-none"
              >
        ...
        {complaint.is_overdue && complaint.status !== 'RESOLVED' && (
          <div className="p-4 bg-[#f8e9e7] border border-[#bd8178] text-[#7e443d] flex items-start space-x-3 shadow-sm rounded-none">
            <AlertOctagon className="w-5 h-5 text-[#7e443d] flex-shrink-0 mt-0.5" />
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider">This complaint is OVERDUE</h4>
              <p className="text-xs text-[#7e443d] mt-0.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-[#faf8f3] border border-[#d8cdbc] p-6 shadow-sm space-y-4 rounded-none">
              <h3 className="font-serif text-lg text-[#24211e] font-normal border-b border-[#d8cdbc] pb-3">
                Description
              </h3>
              <p className="text-sm text-[#6b665e] whitespace-pre-line leading-relaxed">
                {complaint.description}
              </p>

              {/* Attached Photo */}
              {complaint.photo_url && (
                <div className="pt-4 border-t border-[#d8cdbc] space-y-2">
                  <h4 className="text-xs font-bold text-[#5f4b3b] uppercase tracking-wider">
                    Attached Image
                  </h4>
                  <div className="relative inline-block border border-[#d8cdbc] bg-[#FAF8F5] p-2 shadow-sm max-w-full rounded-none">
                    <img
                      src={complaint.photo_url}
                      alt="Attached complaint photo"
                      className="max-h-96 w-auto object-contain border border-[#d8cdbc]"
                    />
                    <a
            ...
            <div className="bg-[#faf8f3] border border-[#d8cdbc] p-6 shadow-sm space-y-4 rounded-none">
              <h3 className="font-serif text-lg text-[#24211e] font-normal border-b border-[#d8cdbc] pb-3 flex items-center justify-between">
                <span>Status History & Notes</span>
                <span className="text-xs text-[#8F8778] font-normal font-sans">
          ...
          <div className="space-y-6">
            {/* Metadata Card */}
            <div className="bg-[#faf8f3] border border-[#d8cdbc] p-6 shadow-sm space-y-4 rounded-none">
              <h3 className="text-xs font-bold text-[#5f4b3b] uppercase tracking-wider border-b border-[#d8cdbc] pb-2">
                Ticket Details
              </h3>

              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-[#6b665e] flex items-center text-xs">
                    <User className="w-3.5 h-3.5 mr-1.5 text-[#8F8778]" /> Resident:
                  </span>
                  <span className="font-semibold text-[#24211e] text-xs">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#6b665e] flex items-center text-xs">
                    <Home className="w-3.5 h-3.5 mr-1.5 text-[#8F8778]" /> Flat Number:
                  </span>
                  <span className="font-semibold text-[#24211e] text-xs">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#6b665e] flex items-center text-xs">
                    <Calendar className="w-3.5 h-3.5 mr-1.5 text-[#8F8778]" /> Raised At:
                  </span>
                  <span className="text-xs text-[#6b665e]">{createdDate}</span>
                </div>

                {resolvedDate && (
                  <div className="flex items-center justify-between pt-2 border-t border-[#d8cdbc]">
                    <span className="text-[#3e5d3b] flex items-center text-xs font-semibold">
                      <CheckCircle2 className="w-3.5 h-3.5 mr-1.5" /> Resolved At:
                    </span>
                    <span className="text-xs text-[#6b665e]">{resolvedDate}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            {isAdmin && (
              <div className="bg-[#faf8f3] text-[#24211e] p-6 border border-[#d8cdbc] shadow-sm space-y-4 rounded-none">
                <div className="flex items-center space-x-2 border-b border-[#d8cdbc] pb-2">
                  <Shield className="w-5 h-5 text-[#5f4b3b]" />
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#5f4b3b]">
                    Admin Controls
                  </h3>
                </div>

                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-[#5f4b3b] mb-2">
                    Priority Level:
                  </label>
                      ...
                      <button
                        ...
                        className={`py-2 px-2 text-xs font-semibold uppercase tracking-wider border transition-all rounded-none ${
                          complaint.priority === prio
                            ...
                            : 'bg-[#FAF8F5] text-[#6b665e] border-[#d8cdbc] hover:bg-[#ebe5da] hover:text-[#24211e]'
                        } disabled:opacity-50`}
                      >
                        {prio}
                      </button>
                ...
                {complaint.status !== 'RESOLVED' && (
                  <button
                    type="button"
                    onClick={() => setIsStatusModalOpen(true)}
                    className="w-full mt-2 py-3 px-4 bg-[#24211e] hover:bg-[#3f3025] text-[#FAF8F5] font-semibold text-xs uppercase tracking-wider border border-[#24211e] transition-colors shadow-sm rounded-none"
                  >
