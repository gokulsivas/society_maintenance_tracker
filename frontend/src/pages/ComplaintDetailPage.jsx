    ...
    <div className="editorial-page-surface min-h-[calc(100vh-5rem)] py-8 sm:py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {complaint.is_overdue && complaint.status !== 'RESOLVED' && (
          <div className="p-4 bg-[#fbeeed] border border-[#d9a8a0] text-[#8a4d43] flex items-start space-x-3 shadow-sm">
            <AlertOctagon className="w-5 h-5 text-[#8a4d43] flex-shrink-0 mt-0.5" />
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider">This complaint is OVERDUE</h4>
              <p className="text-xs text-[#8a4d43] mt-0.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-[#faf8f3] border border-[#d8cdbc] p-6 shadow-sm space-y-4">
              ...
              {complaint.photo_url && (
                <div className="pt-4 border-t border-[#d8cdbc] space-y-2">
                  ...
                  <div className="relative inline-block border border-[#d8cdbc] bg-[#FAF8F5] p-2 shadow-sm max-w-full">
                    <img
                    ...
                    <a
                      ...
                      className="absolute bottom-4 right-4 inline-flex items-center px-3 py-1.5 bg-[#24211e]/85 text-[#FAF8F5] text-xs font-medium uppercase tracking-wider hover:bg-[#24211e]"
                    >
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                {resolvedDate && (
                  <div className="flex items-center justify-between pt-2 border-t border-[#d8cdbc]">
                    <span className="text-[#52634a] flex items-center text-xs font-semibold">
            ...
            {isAdmin && (
              <div className="bg-[#24211e] architectural-grid-dark text-[#FAF8F5] p-6 border border-[#5f4b3b]/40 shadow-sm space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['LOW', 'MEDIUM', 'HIGH'].map((prio) => (
                      <button
                        ...
                        className={`py-2 px-2 text-xs font-semibold uppercase tracking-wider border transition-all ${
                ...
                {complaint.status !== 'RESOLVED' && (
                  <button
                    type="button"
                    onClick={() => setIsStatusModalOpen(true)}
                    className="w-full mt-2 py-3 px-4 bg-[#FAF8F5] hover:bg-[#ebe5da] text-[#24211e] font-semibold text-xs uppercase tracking-wider border border-[#FAF8F5] transition-colors shadow-sm"
                  >
